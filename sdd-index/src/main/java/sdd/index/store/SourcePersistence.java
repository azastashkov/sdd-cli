...
public final class SourcePersistence {
     ...
     * If the exact append text is already present, the append is skipped — a repeated identical
     * failure (e.g. retried indexing hitting the same error) must not grow the column unbounded.
     */
